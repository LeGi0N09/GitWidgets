...
export default async function profileWidget(
    ...
    if (dataOptions.length > 4) {
        return errorWidget('Profile', '-25%', `Can't have more than 4 data-options!`, '-40%')
    }
    ...
    try {
        ...
        for (let i = 0; i < dataOptions.length; i++) {
            ...
            switch (opt) {
                case 'followers':
                    addDataBox('followers', i, profile.data.user.followers.totalCount, '#CAF0FF', '#00C6FF',
                    ...
                    break
                case 'repositories':
                    addDataBox('repositories', i, profile.data.user.repositories.totalCount, '#FFCEE4', '#FF0774',
                    ...
                    break
                case 'stars':
                    addDataBox('stars', i, stargazers.reduce((a, b) => a + b, 0), '#FFEFCD', '#FFA100',
                ...
                case 'commits':
                    ...
                    break
                default:
                    return errorWidget('Profile', '-25%', `Invalid data item found!`, '-26%')
            }
        }
